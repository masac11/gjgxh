...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="/">山东省钢结构协会</a>>><a href="#">会员之窗</a></span>常务理事单位</h2>
    <ul>
        ...
        if ($allLeaguer!=null) {
            ...
            if ($pageLeaguer!=null) {
                for ($i=0; $i < count($pageLeaguer); $i++) { 
                    $content = "<li><a href='routineDetail.php?leaguerId=".$pageLeaguer[$i]['leaguerId']."'><span>" . "</span>".$pageLeaguer[$i]['title']." </a></li>";
                    echo $content;
                }
            }else{
