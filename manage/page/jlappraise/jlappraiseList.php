                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
                                    <form action="jlappraiseList.php">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='jlappraiseAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allAppraise = $appraise->selectAppraiseByKeyword($_REQUEST['keyword'], "山东省钢结构行业优秀项目经理");
                                            }else{
                                            ...
                                            if ($allAppraise!=null) {
                                                ...
                                                if ($pageAppraise!=null) {
                                                    for ($i=0; $i < count($pageAppraise); $i++) { 
                                                        ...
                                                        $content .= "<td>". 
                                                        "<a href='jlappraiseDetail.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='jlappraiseEdit.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
