                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='standardAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allStandard = $standard->selectStandardByKeyword($_REQUEST['keyword']);
                                            }else{
                                                $allStandard = $standard->selectAllStandard();
                                            }
                                            
                                            if ($allStandard!=null) {
                                                $totalNum = count($allStandard); //数据总条数
                                                $pageSize = 8;
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pageStandard = $standard->selectStandardByPageKeyword($offset, $pageSize, $_REQUEST['keyword']);
                                                }else{
                                                    $pageStandard = $standard->selectStandardByPage($offset, $pageSize);
                                                }

                                                if ($pageStandard!=null) {
                                                    for ($i=0; $i < count($pageStandard); $i++) { 
                                                        $content = "<tr><td>" . $pageStandard[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pageStandard[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='standardDetail.php?standardId=".$pageStandard[$i]['standardId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='standardEdit.php?standardId=".$pageStandard[$i]['standardId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/standardDao.php?mode=del&standardId=".$pageStandard[$i]['standardId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
