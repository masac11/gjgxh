                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="table-responsive">
                                <form action="../../dao/standardDao.php?mode=edit&standardId=<?php echo $standardId;?>" method="post">
                                    <table class="table table-striped">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">标题</span>
                                            </div>
                                            <input type="text" name="title" class="form-control" required="" value="<?php echo $editStandard[0]['title'];?>" placeholder="请输入标题">
                                        </div>
                                        <thead>
                                            <tr>
                                                <th>输入内容:</th>
                                            ...
                                            <tr>
                                                <td><!-- 加载编辑器的容器 -->
                                                    <script id="container" name="content" type="text/plain">
                                                        <?php echo $editStandard[0]['content'];?>
                                                    </script>
                                                    <!-- 配置文件 -->
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                         ...
                                                         <input type="text" name="time" value="<?php echo $editStandard[0]['time'];?>"  class="form-control" required="" id="date">
                                                    </div>
