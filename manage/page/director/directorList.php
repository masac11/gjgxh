                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='directorAdd.php'" class="btn btn-primary">
                                            ...
                                            if ($allLeaguer!=null) {
                                                ...
                                                if ($pageLeaguer!=null) {
                                                    for ($i=0; $i < count($pageLeaguer); $i++) { 
                                                        ...
                                                        $content .= "<td>". 
                                                        "<a href='directorDetail.php?leaguerId=".$pageLeaguer[$i]['leaguerId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='directorEdit.php?leaguerId=".$pageLeaguer[$i]['leaguerId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
