                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                             <div class="input-group mb-3">
                                ...
                                <input type="text" name="title" class="form-control" required="" value="<?php echo $editLaw[0]['title'];?>" readonly/>
                            </div>
                        </div>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $editLaw[0]['content']?></td>
                                        </tr> 
                                         <tr>
                                            <td>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                     ...
                                                     <input type="text" name="time" value="<?php echo $editLaw[0]['time'];?>"  class="form-control" readonly  id="date"/>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
