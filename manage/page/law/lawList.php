                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='lawAdd.php'" class="btn btn-primary">
...
<!-- 	                                <button type="button" id="delBtn" class="btn btn-danger">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php
                                            require '../../model/Law.class.php';
                                            $law = new Law();
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allLaw = $law->selectLawByKeyword($_REQUEST['keyword']);
                                            }else{
                                            ...
                                            if ($allLaw!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pageLaw = $law->selectLawByPageKeyword($offset, $pageSize, $_REQUEST['keyword']);
                                                }else{
                                                ...
                                                if ($pageLaw!=null) {
                                                    for ($i=0; $i < count($pageLaw); $i++) { 
                                                        $content = "<tr><td>" . $pageLaw[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pageLaw[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='lawDetail.php?lawId=".$pageLaw[$i]['lawId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='lawEdit.php?lawId=".$pageLaw[$i]['lawId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/lawDao.php?mode=del&lawId=".$pageLaw[$i]['lawId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
