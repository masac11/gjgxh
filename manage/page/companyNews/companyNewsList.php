                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
                                    <form action="companyNewsList.php">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='companyNewsAdd.php'" class="btn btn-primary">
...
<!-- 	                                <button type="button" id="delBtn" class="btn btn-danger">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php
                                            require '../../model/companyNews.class.php';
                                            $companyNews = new companyNews();
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allcompanyNews = $companyNews->selectcompanyNewsByKeyword($_REQUEST['keyword']);
                                            }else{
                                                $allcompanyNews = $companyNews->selectAllcompanyNews();
                                            }
                                            
                                            if ($allcompanyNews!=null) {
                                                $totalNum = count($allcompanyNews); //数据总条数
                                                $pageSize = 8;
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pagecompanyNews = $companyNews->selectcompanyNewsByPageKeyword($offset, $pageSize, $_REQUEST['keyword']);
                                                }else{
                                                    $pagecompanyNews = $companyNews->selectcompanyNewsByPage($offset, $pageSize);
                                                }

                                                if ($pagecompanyNews!=null) {
                                                    for ($i=0; $i < count($pagecompanyNews); $i++) { 
                                                        $content = "<tr><td>" . $pagecompanyNews[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pagecompanyNews[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='companyNewsDetail.php?companyNewsId=".$pagecompanyNews[$i]['companyNewsId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='companyNewsEdit.php?companyNewsId=".$pagecompanyNews[$i]['companyNewsId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/companyNewsDao.php?mode=del&companyNewsId=".$pagecompanyNews[$i]['companyNewsId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
