                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='ggnewsAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allNews = $news->selectNewsByKeyword($_REQUEST['keyword'], "通知公告");
                                            }else{
                                            ...
                                            if ($allNews!=null) {
                                                ...
                                                if ($pageNews!=null) {
                                                    for ($i=0; $i < count($pageNews); $i++) { 
                                                        ...
                                                        $content .= "<td>". 
                                                        "<a href='ggnewsDetail.php?newsId=".$pageNews[$i]['newsId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='ggnewsEdit.php?newsId=".$pageNews[$i]['newsId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
