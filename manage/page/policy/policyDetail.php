...
<?php
    ...
    $policy = new Policy();
    $policys = $policy->getPolicyByPolicyId($policyId);
?>
<!doctype html>
<html>
<head>
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
	                         <div class="input-group mb-3">
                                ...
                                <input type="text" name="policyTitle" class="form-control" required="" value="<?php echo $policys[0]['policyTitle'];?>" readonly/>
                            </div>
                        </div>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $policys[0]['policyContent']?></td>
                                        </tr> 
                                         <tr>
                                            <td>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                     ...
                                                     <input type="text" name="policyTime" value="<?php echo $policys[0]['policyTime'];?>"  class="form-control" readonly  id="date"/>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
