                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='policyAdd.php'" class="btn btn-primary">
...
<!-- 	                                <button type="button" id="delBtn" class="btn btn-danger">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php
                                            require '../../model/Policy.class.php';
                                            $policy = new Policy();
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allPolicy = $policy->selectPolicyByKeyword($_REQUEST['keyword']);
                                            }else{
                                            ...
                                            if ($allPolicy!=null) {
                                                ...
                                                if ($pagePolicy!=null) {
                                                    for ($i=0; $i < count($pagePolicy); $i++) { 
                                                        $content = "<tr><td>" . $pagePolicy[$i]['policyTitle'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pagePolicy[$i]['policyTime'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='policyDetail.php?policyId=".$pagePolicy[$i]['policyId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='policyEdit.php?policyId=".$pagePolicy[$i]['policyId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/policyDao.php?mode=del&policyId=".$pagePolicy[$i]['policyId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
