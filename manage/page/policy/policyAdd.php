                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="table-responsive">
                                <form action="../../dao/policyDao.php?mode=add" method="post">
                                    <table class="table table-striped">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">标题</span>
                                            </div>
                                            <input type="text" name="policyTitle" class="form-control" required="" placeholder="请输入标题">
                                        </div>
                                        <thead>
                                            <tr>
                                                <th>输入内容:</th>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                         ...
                                                         <input type="text" name="policyTime" class="form-control" required="" id="date">
                                                    </div>
