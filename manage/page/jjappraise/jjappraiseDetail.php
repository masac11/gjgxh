                    ...
                    <div class="card">
                        <div class="card-header bg-light">
	                         <div class="input-group mb-3">
                                ...
                                <input type="text" name="title" class="form-control" required="" value="<?php echo $editAppraise[0]['title'];?>" readonly/>
                            </div>
                        </div>
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th>标题图片:<img width="270px" height="100" src="<?php echo "http://".$_SERVER['HTTP_HOST'] . "/gjgxh/upload/".$editAppraise[0]['img_path'];?>"></th>
                                        </tr>
                                        <tr>
                                            <th>内容:</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $editAppraise[0]['content']?></td>
                                        </tr> 
                                         <tr>
                                            <td>
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                     ...
                                                     <input type="text" name="time" value="<?php echo $editAppraise[0]['time'];?>"  class="form-control" readonly  id="date"/>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
