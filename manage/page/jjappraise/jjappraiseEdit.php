                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="table-responsive">
                                <form action="../../dao/appraiseDao.php?mode=edit&appraise_id=<?php echo $appraise_id;?>" method="post"  enctype="multipart/form-data">
                                    <table class="table table-striped">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">标题</span>
                                            </div>
                                            <input type="text" name="title" class="form-control" required="" value="<?php echo $editAppraise[0]['title'];?>" placeholder="请输入标题">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">标题图片</span>
                                            </div>
                                            ...
                                            <tr>
                                                <td><!-- 加载编辑器的容器 -->
                                                    <script id="container" name="content" type="text/plain">
                                                        <?php echo $editAppraise[0]['content'];?>
                                                    </script>
                                                    <!-- 配置文件 -->
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                         ...
                                                         <input type="text" name="time" value="<?php echo $editAppraise[0]['time'];?>"  class="form-control" required="" id="date">
                                                    </div>
