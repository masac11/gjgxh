                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
                                    <form action="jjappraiseList.php">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='jjappraiseAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allAppraise = $appraise->selectAppraiseByKeyword($_REQUEST['keyword'], "山东省钢结构金奖");
                                            }else{
                                            ...
                                            if ($allAppraise!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pageAppraise = $appraise->selectAppraiseByPageKeyword($offset, $pageSize, $_REQUEST['keyword'], "山东省钢结构金奖");
                                                }else{
                                                    $pageAppraise = $appraise->selectAppraiseByPage($offset, $pageSize, "山东省钢结构金奖");
                                                }
                                                ...
                                                if ($pageAppraise!=null) {
                                                    for ($i=0; $i < count($pageAppraise); $i++) { 
                                                        ...
                                                        $content .= "<td>". 
                                                        "<a href='jjappraiseDetail.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='jjappraiseEdit.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
