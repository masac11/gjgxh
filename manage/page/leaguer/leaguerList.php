                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='leaguerAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                ...
                                                $allLeaguer = $leaguer->selectAllLea();
                                            }
                                            ...
                                            if ($allLeaguer!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    ...
                                                    $pageLeaguer = $leaguer->selectLeaByPage($offset, $pageSize);
                                                }
                                                ...
                                                if ($pageLeaguer!=null) {
                                                    for ($i=0; $i < count($pageLeaguer); $i++) { 
                                                        ...
                                                        $content .= "<td>". 
                                                        "<a href='leaguerDetail.php?leaguerId=".$pageLeaguer[$i]['leaguerId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='leaguerEdit.php?leaguerId=".$pageLeaguer[$i]['leaguerId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
