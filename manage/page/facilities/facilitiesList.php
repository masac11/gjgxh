                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
                            <div class="row">
                                <div class="col-md-4">
                                    <form action="facilitiesList.php">
                                        <div class="input-group">
                                             <input type="text" id="keyword" name="keyword" name="input1-group2" class="form-control" placeholder="输入基地名">
                                ...
                                <div class="col-md-6">
                                    <button type="button" onclick="javascript:location.href='facilitiesAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allfacilities = $facilities->selectfacilitiesByKeyword($_REQUEST['keyword']);
                                            }else{
                                                $allfacilities = $facilities->selectAllfacilities();
                                            }
                                            
                                            if ($allfacilities!=null) {
                                                $totalNum = count($allfacilities); //数据总条数
                                                $pageSize = 8;
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pagefacilities = $facilities->selectfacilitiesByPageKeyword($offset, $pageSize, $_REQUEST['keyword']);
                                                }else{
                                                    $pagefacilities = $facilities->selectfacilitiesByPage($offset, $pageSize);
                                                }

                                                if ($pagefacilities!=null) {
                                                    for ($i=0; $i < count($pagefacilities); $i++) { 
                                                        $content = "<tr><td>" . $pagefacilities[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pagefacilities[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='facilitiesDetail.php?facilitiesId=".$pagefacilities[$i]['facilitiesId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='facilitiesEdit.php?facilitiesId=".$pagefacilities[$i]['facilitiesId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/facilitiesDao.php?mode=del&facilitiesId=".$pagefacilities[$i]['facilitiesId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
