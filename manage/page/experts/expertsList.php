                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="button" onclick="javascript:location.href='expertsAdd.php'" class="btn btn-primary">
...
<!--                                    <button type="button" id="delBtn" class="btn btn-danger">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php
                                            require '../../model/experts.class.php';
                                            $experts = new experts();
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allexperts = $experts->selectexpertsByKeyword($_REQUEST['keyword']);
                                            }else{
                                            ...
                                            if ($allexperts!=null) {
                                                ...
                                                if ($pageexperts!=null) {
                                                    for ($i=0; $i < count($pageexperts); $i++) { 
                                                        $content = "<tr><td>" . $pageexperts[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pageexperts[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='expertsDetail.php?expertsId=".$pageexperts[$i]['expertsId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='expertsEdit.php?expertsId=".$pageexperts[$i]['expertsId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/expertsDao.php?mode=del&expertsId=".$pageexperts[$i]['expertsId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
