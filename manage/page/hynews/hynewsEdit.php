...
<?php
    ...
    $news = new News();
    $editNews = $news->getNewsByNewsId($newsId);
?>
<!doctype html>
<html>
<head>
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="table-responsive">
                                <form action="../../dao/newsDao.php?mode=edit&newsId=<?php echo $newsId;?>" method="post">
                                    <table class="table table-striped">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">标题</span>
                                            </div>
                                            <input type="text" name="title" class="form-control" required="" value="<?php echo $editNews[0]['title'];?>" placeholder="请输入标题">
                                        </div>
                                        <thead>
                                            <tr>
                                                <th>输入内容:</th>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                         ...
                                                         <input type="text" name="time" value="<?php echo $editNews[0]['time'];?>"  class="form-control" required="" id="date">
                                                    </div>
