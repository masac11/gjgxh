                        ...
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='hynewsAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allNews = $news->selectNewsByKeyword($_REQUEST['keyword'], "行业动态");
                                            }else{
                                                $allNews = $news->selectAllNews("行业动态");
                                            }
                                            ...
                                            if ($allNews!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pageNews = $news->selectNewsByPageKeyword($offset, $pageSize, $_REQUEST['keyword'], "行业动态");
                                                }else{
                                                    $pageNews = $news->selectNewsByPage($offset, $pageSize, "行业动态");
                                                }
                                                ...
                                                if ($pageNews!=null) {
                                                    for ($i=0; $i < count($pageNews); $i++) { 
                                                        ...
                                                        $content .= "<td>". 
                                                        "<a href='hynewsDetail.php?newsId=".$pageNews[$i]['newsId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='hynewsEdit.php?newsId=".$pageNews[$i]['newsId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
