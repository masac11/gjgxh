...
<?php
    ...
    $Procedure = $Admission->selectAllProcedure();
?>
<!doctype html>
<html>
<head>
                    ...
                    <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $Procedure[0]['content']?></td>
                                        </tr> 
                                    ...
                                    <tr>
                                        <td colspan="1" class="text-center" >
                                             <button type="button" onclick="location.href='procedureEdit.php'" class="btn btn-primary">
                                                 修改
                                            </button>
                                        </td>
                                    </tr>
