                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <button type="button" onclick="javascript:location.href='xhnewsAdd.php'" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allNews = $news->selectNewsByKeyword($_REQUEST['keyword'], "协会动态");
                                            }else{
                                                $allNews = $news->selectAllNews("协会动态");
                                            }
                                            ...
                                            if ($allNews!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pageNews = $news->selectNewsByPageKeyword($offset, $pageSize, $_REQUEST['keyword'], "协会动态");
                                                }else{
                                                    $pageNews = $news->selectNewsByPage($offset, $pageSize, "协会动态");
                                                }

                                                if ($pageNews!=null) {
                                                    for ($i=0; $i < count($pageNews); $i++) { 
                                                        $content = "<tr><td>" . $pageNews[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pageNews[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='xhnewsDetail.php?newsId=".$pageNews[$i]['newsId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='xhnewsEdit.php?newsId=".$pageNews[$i]['newsId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/newsDao.php?mode=del&newsId=".$pageNews[$i]['newsId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
