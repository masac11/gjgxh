                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
                                    <form action="yxappraiseList.php">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='yxappraiseAdd.php'" class="btn btn-primary">
...
<!-- 	                                <button type="button" id="delBtn" class="btn btn-danger">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php
                                            require '../../model/Appraise.class.php';
                                            $appraise = new Appraise();
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allAppraise = $appraise->selectAppraiseByKeyword($_REQUEST['keyword'], "山东省钢结构行业优秀企业家");
                                            }else{
                                                $allAppraise = $appraise->selectAllAppraise("山东省钢结构行业优秀企业家");
                                            }
                                            ...
                                            if ($allAppraise!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pageAppraise = $appraise->selectAppraiseByPageKeyword($offset, $pageSize, $_REQUEST['keyword'], "山东省钢结构行业优秀企业家");
                                                }else{
                                                    $pageAppraise = $appraise->selectAppraiseByPage($offset, $pageSize, "山东省钢结构行业优秀企业家");
                                                }

                                                if ($pageAppraise!=null) {
                                                    for ($i=0; $i < count($pageAppraise); $i++) { 
                                                        $content = "<tr><td>" . $pageAppraise[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pageAppraise[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='yxappraiseDetail.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='yxappraiseEdit.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/appraiseDao.php?mode=del&appraise_id=".$pageAppraise[$i]['appraise_id']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
