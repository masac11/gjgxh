                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="table-responsive">
                                <form action="../../dao/appraiseDao.php?mode=addYx" method="post"  enctype="multipart/form-data">
                                    <table class="table table-striped">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="file" name="file" class="form-control" value="选择处理文件"/>
                                        </div>
                                        <thead>
                                            <tr>
                                                <th>输入内容:</th>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                         ...
                                                         <input type="text" name="time" class="form-control" required="" id="date">
                                                    </div>
