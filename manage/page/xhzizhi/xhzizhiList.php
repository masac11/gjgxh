                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            ...
                            <div class="table-responsive">
                                <form action="../../dao/aboutDao.php?mode=editXhzizhi" method="post">
               							...
               							<tr>
                							<td colspan="1" class="text-center" >
                                                <button type="submit" class="btn btn-primary">
    						            		 ...
    						            		 <button type="button" onclick="location.href='xhzizhi.php'" class="btn btn-primary">
                                                     返回
                                                </button>
    						            	</td>
    					            	</tr>
