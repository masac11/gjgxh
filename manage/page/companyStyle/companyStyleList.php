                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-light">
	                        <div class="row">
		                        <div class="col-md-4">
                                    <form action="companyStyleList.php">
		                     	...
		                     	<div class="col-md-6">
		                            <button type="button" onclick="javascript:location.href='companyStyleAdd.php'" class="btn btn-primary">
...
<!-- 	                                <button type="button" id="delBtn" class="btn btn-danger">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php
                                            require '../../model/companyStyle.class.php';
                                            $companyStyle = new companyStyle();
                                            if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                $allcompanyStyle = $companyStyle->selectcompanyStyleByKeyword($_REQUEST['keyword']);
                                            }else{
                                            ...
                                            if ($allcompanyStyle!=null) {
                                                ...
                                                if (isset($_REQUEST['keyword'])&&$_REQUEST['keyword']!="") {
                                                    $pagecompanyStyle = $companyStyle->selectcompanyStyleByPageKeyword($offset, $pageSize, $_REQUEST['keyword']);
                                                }else{
                                                    $pagecompanyStyle = $companyStyle->selectcompanyStyleByPage($offset, $pageSize);
                                                }

                                                if ($pagecompanyStyle!=null) {
                                                    for ($i=0; $i < count($pagecompanyStyle); $i++) { 
                                                        $content = "<tr><td>" . $pagecompanyStyle[$i]['title'] . "</td>";
                                                        $content .= "<td class='text-nowrap'>" . $pagecompanyStyle[$i]['time'] ."</td>";
                                                        $content .= "<td>". 
                                                        "<a href='companyStyleDetail.php?companyStyleId=".$pagecompanyStyle[$i]['companyStyleId']."'><i class='fa fa-eye'></i>&nbsp;查看内容&nbsp;&nbsp;&nbsp;</a>".  
                                                        "<a href='companyStyleEdit.php?companyStyleId=".$pagecompanyStyle[$i]['companyStyleId']."'><i class='fa fa-wrench'></i> &nbsp;修改&nbsp;&nbsp;&nbsp; </a>".    
                                                        "<a href=\"javascript:if(confirm('确实要删除吗?'))location='../../dao/companyStyleDao.php?mode=del&companyStyleId=".$pagecompanyStyle[$i]['companyStyleId']."'\"><i class='fa fa-trash'></i> &nbsp;删除</a>" . 
                                                        "</td>";
                                                        $content .= "</tr>";
                                                        echo $content;
                                                    }
