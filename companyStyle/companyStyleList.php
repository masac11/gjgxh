...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="/">山东省钢结构协会</a>>><a href="companyStyleList.php">企业风采</a></span>企业风采</h2>
    <ul>
        ...
        if ($allcompanyStyle!=null) {
            ...
            if ($pagecompanyStyle!=null) {
                for ($i=0; $i < count($pagecompanyStyle); $i++) { 
                    $content = "<li><a href='companyStyleDetail.php?companyStyleId=".$pagecompanyStyle[$i]['companyStyleId']."'><span>" . $pagecompanyStyle[$i]['time'] ."</span>".$pagecompanyStyle[$i]['title']." </a></li>";
                    echo $content;
                }
            }else{
