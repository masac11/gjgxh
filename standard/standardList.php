...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="/">山东省钢结构协会</a>>><a href="#">团体标准</a></span>团体标准</h2>
    <ul>

      <?php
        require '../manage/model/Standard.class.php';
        ...
        if ($allStandard!=null) {
            ...
            if ($pageStandard!=null) {
                for ($i=0; $i < count($pageStandard); $i++) { 
                    $content = "<li><a href='standardDetail.php?standardId=".$pageStandard[$i]['standardId']."'><span>" . $pageStandard[$i]['time'] ."</span>".$pageStandard[$i]['title']." </a></li>";
                    echo $content;
                }
            }else{
