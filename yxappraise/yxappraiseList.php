...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="/">山东省钢结构协会</a>>><a href="#">山东省钢结构行业优秀企业家</a></span>山东省钢结构行业优秀企业家</h2>
    <ul>
        ...
        if ($allAppraise!=null) {
            ...
            if ($pageAppraise!=null) {
                for ($i=0; $i < count($pageAppraise); $i++) { 
                    ...
                    $content = "<div style='display:flex;width:200px;'><li><img width='200px' src='../upload/" . $pageAppraise[$i]['img_path'] . "'/><a href='yxappraiseDetail.php?appraise_id=".$pageAppraise[$i]['appraise_id']."'>".$pageAppraise[$i]['title']." </a></li></div>";
