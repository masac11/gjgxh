...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="/">山东省钢结构协会</a>>><a href="#">行业动态</a></span>行业动态</h2>
    <ul>
        ...
        if ($allNews!=null) {
            ...
            if ($pageNews!=null) {
                for ($i=0; $i < count($pageNews); $i++) { 
                    $content = "<li><a href='hynewsDetail.php?newsId=".$pageNews[$i]['newsId']."'><span>" . $pageNews[$i]['time'] ."</span>".$pageNews[$i]['title']." </a></li>";
                    echo $content;
                }
            }else{
