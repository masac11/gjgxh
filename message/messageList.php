<?php
    require '../manage/model/Message.class.php';
    $Message = new Message();
...
<div class="contain">
  ...
  <div class="listr right">
    <h2><span>您现在的位置: <a href="/">山东省钢结构协会</a>>><a href="messageList.php">文件下载</a></span>文件下载</h2>
    <ul>
      <?php
        if ($allMessage!=null) {
            ...
            if ($pageMessage!=null) {
                for ($i=0; $i < count($pageMessage); $i++) { 
                    $content = "<li><a href='messageDetail.php?messageId=".$pageMessage[$i]['messageId']."'><span>" . $pageMessage[$i]['messageTime'] ."</span>".$pageMessage[$i]['messageTitle']." </a></li>";
                    echo $content;
                }
            }else{
